...
/**
 *
 * @fn int ConfirmarGestion(char[], char[])
 * @brief Solicita un char al usuario, luego de verificarlo lo devuelve
 *
 * @param mensaje Es el mensaje a ser mostrado
 * \param mensajeError Es el mensaje de Error a ser mostrado
 * @return
...
/**
 * @fn int ConfirmarGestion(char[], char[])
 * @brief Solicitar al usuario que confirme gestión
 *
 * @param mensaje Es el mensaje a ser mostrado
 * \param mensajeError Es el mensaje de Error a ser mostrado
 * \param reintentos Cantidad de reintentos
 * @return Retorna 0 si usuario cancela gestión y 1 si confirma gestión
 */
